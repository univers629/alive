...
class Config:
    ...
    def __init__(self):
        ...
        try:
            ...
            raise u.AliveException(f'Invalid config!\n{e}')
        ...
        # `[static]` is interpreted by the FastAPI data layer as all themed
        # static-resource routes; keep the marker instead of expanding a
        # directory snapshot at startup.
